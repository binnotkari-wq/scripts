...
#
# Usage:
#   ./check_system_health.sh [-b BOOT_OFFSET] [-s SINCE] [-p] [-o OUTFILE]
#
...
main() {
  log_info "Analyse du boot offset=${BOOT_OFFSET}$( [[ -n "${SINCE}" ]] && echo ", depuis '${SINCE}'" )"
